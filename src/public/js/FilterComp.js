...
<!--                </button>-->
<!--            </form>-->
                <form action="#" class="headerForm" @submit.prevent="$parent.$refs.products.filter(userSearch)">
                    ...
                    <input type="text" placeholder="Search for Item..." class="headerInput" v-model="userSearch">
